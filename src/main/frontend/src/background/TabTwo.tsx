...
const TabTwo = () => {
  ...
  return (
    <div className='min-h-[92vh] bg-gray-50 px-6 py-8' data-theme='aqua'>
      <h1 className='text-3xl font-bold text-gray-800 mb-6'>Infosys Live Stock Data</h1>

      <div className='max-w-md mx-auto bg-white border border-gray-200 shadow-lg rounded-2xl p-4'>
      <h2 className='text-xl font-semibold text-gray-900 mb-3'>{symbol}</h2>
